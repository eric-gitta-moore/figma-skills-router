...
**MANDATORY**: You MUST also load [figma-use](../figma-use/GUIDE.md) before any `use_figma` call. That skill contains critical rules (color ranges, font loading, etc.) that apply to every script you write.
...
- If the user wants to generate **code from a Figma design**, switch to [figma-implement-design](../figma-implement-design/GUIDE.md).
- If the user wants to create **new reusable components or variants**, use [figma-use](../figma-use/GUIDE.md) directly.
- If the user wants to write **Code Connect mappings**, switch to [figma-code-connect](../figma-code-connect/GUIDE.md).
...
For detailed API patterns and gotchas, load these from the [figma-use](../figma-use/GUIDE.md) references as needed:
...
Follow the error recovery process from [figma-use](../figma-use/GUIDE.md#6-error-recovery--self-correction):
